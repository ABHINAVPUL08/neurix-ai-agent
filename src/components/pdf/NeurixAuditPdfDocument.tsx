  ...
  return (
    <>
      ...
      <View fixed style={styles.footer}>
        ...
        />
        <Text>Generated by Neurix AI</Text>
      </View>
    </>
  );
}
...
function CoverPage({ data }: { data: AuditReportExportData }) {
  ...
  return (
    <Page size="A4" style={styles.coverPage}>
      ...
      <Text style={styles.coverPrepared}>Prepared by Neurix AI</Text>
        ...
        <PageChrome logoSrc={logoSrc}>
          ...
          <View style={styles.closingBox}>
            <Text style={styles.closingText}>
              This report was generated by Neurix AI. For a custom implementation
...
export function NeurixAuditPdfDocument({
  ...
  return (
    <Document
      title="Neurix AI Business Audit Report"
      author="Neurix AI"
